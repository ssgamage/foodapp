        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                'assets/images/shop_more_details/Easy-Chicken-Curry-square-FS-117.jpg',
                fit: BoxFit.contain,
              ),
            ),
            Padding(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            // Handle the "View Location" button press
                          },
                          style: ButtonStyle(
                            backgroundColor:
                        ...
                        ElevatedButton(
                          onPressed: () {
                            // Handle the "Reserve" button press
                          },
                          style: ButtonStyle(
                            backgroundColor:
                                MaterialStateProperty.all<Color>(Colors.orange),
